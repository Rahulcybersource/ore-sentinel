    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
        ...
        <motion.div
          ...
          className="bg-navy-950 border border-saffron-500/20 rounded-lg p-5 md:p-6 shadow-[0_0_15px_rgba(0,32,91,0.5)] relative overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-full h-1 bg-saffron-500/50"></div>
          <div className="flex justify-between items-start mb-4">
            <div>
              <span className="text-[10px] font-mono text-saffron-500/70 uppercase tracking-widest">Daily Tonnage</span>
              <div className="text-2xl md:text-3xl font-mono font-bold text-saffron-400 mt-1">
            ...
            <div className="p-2 border border-saffron-500/20 bg-navy-900 rounded"><Activity size={20} className="text-saffron-500" /></div>
          </div>
          <div className="text-xs font-mono font-medium">
            <span className={currentActual >= currentPlanned ? "text-green-500" : "text-red-500"}>
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              <span className="text-[10px] font-mono text-saffron-500/70 uppercase tracking-widest">Active Risks</span>
              <div className="text-2xl md:text-3xl font-mono font-bold text-red-500 mt-1">
                <CountUp value={activeAlertCount} format={(v) => Math.round(v).toString()} />
              </div>
            </div>
            <div className="p-2 border border-red-500/20 bg-navy-900 rounded"><AlertTriangle size={20} className="text-red-500" /></div>
          </div>
        ...
        >
          ...
          <div className="flex justify-between items-start mb-4">
            <div>
              <span className="text-[10px] font-mono text-saffron-500/70 uppercase tracking-widest">Avg Confidence</span>
              <div className="text-2xl md:text-3xl font-mono font-bold text-saffron-400 mt-1">
                <CountUp value={avgConfidence * 100} format={(v) => v.toFixed(1)} />
                <span className="text-base md:text-lg text-slate-500 ml-1">%</span>
              </div>
            </div>
            <div className="p-2 border border-saffron-500/20 bg-navy-900 rounded"><Database size={20} className="text-saffron-500" /></div>
          </div>
          <div className="text-xs font-mono font-medium text-slate-400">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
        ...
        <motion.div
          ...
          className="bg-navy-950 border border-saffron-500/20 rounded-lg p-5 md:p-6 shadow-[0_0_15px_rgba(0,32,91,0.5)]"
        >
          <h3 className="text-xs font-mono text-saffron-500/70 uppercase tracking-widest mb-6">7-Day Production Trend</h3>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={sparklineData}>
                ...
                <Line 
                  ...
                  stroke="#FF9933" 
                  strokeWidth={2} 
                  dot={{ r: 3, fill: '#0B1220', strokeWidth: 2, stroke: '#FF9933' }}
                  activeDot={{ r: 5, fill: '#FF9933' }} 
                />
              </LineChart>
            </ResponsiveContainer>
          </div>
        ...
        <motion.div
          ...
          className="bg-navy-950 border border-saffron-500/20 rounded-lg p-5 md:p-6 shadow-[0_0_15px_rgba(0,32,91,0.5)] flex flex-col"
        >
          <h3 className="text-xs font-mono text-saffron-500/70 uppercase tracking-widest mb-6">Top Active Risks</h3>
            ...
            {topAlerts.length === 0 ? (
              ...
              topAlerts.map((alert, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-3 md:gap-4 p-3 md:p-4 rounded border border-saffron-500/10 bg-navy-900"
                >
                  <div className={`mt-0.5 border p-1.5 shrink-0 rounded ${alert.severity === 'CRITICAL' ? 'bg-red-500/10 border-red-500/30 text-red-500' : 'bg-saffron-500/10 border-saffron-500/30 text-saffron-500'}`}>
